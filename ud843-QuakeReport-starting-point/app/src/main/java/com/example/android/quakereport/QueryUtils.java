...
/**
 * Created by DENNIS on 6/30/2017.
 */
public final class QueryUtils {
     ...
     */
        ...
        /**
         * Return a list of {@link EarthClass} objects that has been built up from
         * parsing a JSON response.
         */
        public static ArrayList<EarthClass> extractEarthquakes() {

            // Create an empty ArrayList that we can start adding earthquakes to
            ArrayList<EarthClass> earthquakes = new ArrayList<>();
            ...
            try {
                ...
                for (int i = 0; i < earthQuakeArray.length(); i++){
                    ...
                    EarthClass earthClass = new EarthClass(magnitude,place,time,url);
                    earthquakes.add(earthClass);
                }
